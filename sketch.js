...
// The sun moves and reacts to the user's mouse movement.
//
// Instructions:
// Move the mouse to move the sun.
// Click the mouse to change the sun's direction.
...
function draw() {
  ...
  // mouseX and mouseY control the sun
  sunX = mouseX;
  sunY = 50 + mouseY * 0.2;
  ...
  // When the sun reaches the edge, change direction
  if (sunX > 750 || sunX < 50) {
    sunSpeed = -sunSpeed;
  }
...
// Mouse click changes the sun's direction
